...
fn assert_sign_mechanims_reject<B: 'static>(key: KeyId, client: &mut impl CryptoClient<B>) {
    for m in [
        Mechanism::Ed255,
...
fn assert_encrypt_mechanims_reject<B: 'static>(key: KeyId, client: &mut impl CryptoClient<B>) {
